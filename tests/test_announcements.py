...
class TestAnnouncement:
    ...
    def test_edit_foreign_announcement(self, get_id_create_announcement, signup_signin_user):
        ...
        name2 = "Stranger"
        requests.post(site.signup, json={"email": email2, "password": password2, "name": name2})

        signin_response = requests.post(site.signin, json={"email": email2, "password": password2})
